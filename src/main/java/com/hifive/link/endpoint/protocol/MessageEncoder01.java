...
import com.hifive.link.endpoint.MessageType.HeaderType;
import com.hifive.link.endpoint.MessageType.ValueFormat;
...
public class MessageEncoder01 implements MessageIO.MessageEncoder {
	@Override
