...
public abstract class RemotingServerChannelHandler extends SimpleChannelHandler {
	...
	public final void onMessage(final ChannelContext context) throws ChannelException, Exception {
	...
	private void onMessage(final ChannelContext context, Object msg) throws ChannelException, Exception {
