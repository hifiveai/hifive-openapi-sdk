...
public class HifiveHQListenRequest extends HifiveBaseRequest<HifiveHQListenResponse> {
    ...
    public Class<HifiveHQListenResponse> getResponseClass() {
        return HifiveHQListenResponse.class;
    }
