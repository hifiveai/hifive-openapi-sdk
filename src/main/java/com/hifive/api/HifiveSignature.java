...
public class HifiveSignature {
    ...
    public static String rsaSign(String content, String privateKey, String charset)
        ...
        try {
            PrivateKey priKey = getPrivateKeyFromPKCS8(HifiveConstants.SIGN_TYPE_RSA,
                new ByteArrayInputStream(privateKey.getBytes()));

            java.security.Signature signature = java.security.Signature
                .getInstance(HifiveConstants.SIGN_ALGORITHMS);
            ...
            throw new HifiveApiException("RSAcontent = " + content + "; charset = " + charset, e);
        }
    }
