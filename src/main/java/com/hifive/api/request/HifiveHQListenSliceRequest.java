...
public class HifiveHQListenSliceRequest extends HifiveBaseRequest<HifiveHQListenSliceResponse> {
    ...
    public Class<HifiveHQListenSliceResponse> getResponseClass() {
        return HifiveHQListenSliceResponse.class;
    }
