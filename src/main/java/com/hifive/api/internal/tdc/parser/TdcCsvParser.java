...
import com.hifive.api.internal.tdc.CsvMetaData;
import com.hifive.api.internal.tdc.CsvTdcResponse;
...
public class TdcCsvParser implements TdcParser {
	...
	private void errorRecord(CsvReader cr, CsvTdcResponse csvRsp, String rsp,
